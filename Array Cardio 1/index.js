// ## Array Cardio Day 1
    ...
    const inventors = [
     ...
     console.log(fifteen)
      ...
      const totalYears=inventors.reduce((total, inv)=> {return total+(inv.passed - inv.year);}, 0);
      ...
      //const links = Array.from(category.querySelectorAll('a')); //converting into array because for map we need that
